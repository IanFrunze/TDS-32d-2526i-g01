...
import pt.isel.reversi.core.FakeGameService
...
data class PreviewAppState(
    override val game: Game = Game(config = CoreConfig(emptyMap()), service = FakeGameService()),
    ...
    override val service: GameServiceImpl = FakeGameService()
): AppStateImpl